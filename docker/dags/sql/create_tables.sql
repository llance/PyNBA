CREATE TABLE IF NOT EXISTS nba_api.shotchartdetail (
...
CREATE TABLE IF NOT EXISTS nba_api.playercareerstats (
	PLAYER_ID INTEGER,
...
CREATE TABLE IF NOT EXISTS nba_api.teams (
...
CREATE TABLE IF NOT EXISTS nba_api.roster (
	PRIMARY KEY(PLAYERID),
	TEAMID  INTEGER,
	SEASON  INTEGER,
	LEAGUEID  INTEGER,
